    ...
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16 justify-center">
            <div className="bg-primary-50 dark:bg-slate-800/50 p-6 rounded-lg text-center border border-primary-100 dark:border-slate-700 max-w-2xl">
              <h4 className="font-semibold text-slate-800 dark:text-slate-200 mb-2">Who I Work With:</h4>
              <p className="text-slate-600 dark:text-slate-400">
                Startups scaling their data operations • Small-to-medium businesses drowning in spreadsheets • Teams ready to move from manual reporting to automated insights
              </p>
            </div>
        </div>
